...
- TECH_DEBT.md tracks known code-quality debt. Before editing a file listed there, clear its entries in the same pass — don't open a separate cleanup PR. `npm run verify` currently fails at lint because of it; that's expected and recorded.
